...
from src.application.usecases.groups_ismart.create_groups_switch_by_lights_usecase import CreateGroupsSwitchByLightUseCase 
...
async def grupos_config_file_facts(file: UploadFile, factory: RepositoriesFactory = Injected(RepositoriesFactory)):
    try:
        ...
        create_groups_switch_by_lights_usecase: CreateGroupsSwitchByLightUseCase = CreateGroupsSwitchByLightUseCase(dataframe)
        create_groups_switch_by_lights_usecase.execute()
