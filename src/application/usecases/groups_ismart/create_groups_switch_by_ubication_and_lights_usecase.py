        ...
        try:
            ...
            for zona in zonas:
                ...
                for ubi in ubication:
                    ...
                    dict_df_switches_by_ubication = GroupsUtilUseCase.build_dict_group_switch(df_switches_by_ubication, name_group_by_ubication, unique_id)
                    ...
                    if dict_df_switches_by_ubication:
                        ...
                        path_save_yaml = PathsIsmartUseCase.path_join_any_directores([self.path_ismart_principal,'Zonas', zona,'Ubicacion', ubi, 'Integraciones','grupos','switch'])
                        ...
                        row_df_switches_by_ubicaction_and_light = {
                                                                ...
                                                                NameColumnDfGroupEnum.entity.value:'switch.'+StringUtilUseCase.tranform_string_to_slug(name_group_by_ubication),
                        ...
                        row_df_path_yamls= {
                            NameColumnDfGroupPathFulesEnum.name_.value:name_group_by_ubication, 
            ...
            return df_groups_by_ubication_and_light,df_yamls_paths
